        ...
        <div className={container()}>
          <Grid columns={12} className={css({ py: '4' })}>
            <GridItem colSpan={3}>
              ...
              <ul
                className={flex({ gap: '4', alignContent: 'center', py: '4' })}
              >
                <li>
                  <svg
            ...
            <GridItem colSpan={2}>
              <FooterMenu
                title={t('footer.company.title', { ns: 'common' })}
                items={[
                  {
                    title: t('footer.company.about', { ns: 'common' }),
                    path: getLocalizedPath('/about'),
                  },
                  {
                    title: t('footer.company.jobs', { ns: 'common' }),
                    path: '/jobs',
                  },
                ]}
              />
            ...
            <GridItem colSpan={2}>
              <FooterMenu
                title={t('footer.services.title', { ns: 'common' })}
                items={[
                  {
                    title: t('footer.services.strategy', { ns: 'common' }),
                    path: getLocalizedPath('/strategy'),
                  },
                  {
                    title: t('footer.services.revops', { ns: 'common' }),
            ...
            <GridItem colSpan={2}>
              <FooterMenu
                title={t('footer.resources.title', { ns: 'common' })}
                items={[
                  {
                    title: t('footer.resources.events', { ns: 'common' }),
                    path: '/events',
                  },
                  {
                    title: t('footer.resources.blog', { ns: 'common' }),
                    path: '/blog',
                  },
                  {
                    title: t('footer.resources.tools', { ns: 'common' }),
                    path: '/tools',
                  },
                ]}
              />
            ...
            <GridItem colSpan={3}>
              <p className={css({ mb: '3' })}>
                {t('footer.newsletter.title', { ns: 'common' })}
              </p>
