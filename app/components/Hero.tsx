...
export function Hero() {
  return (
    <div className="desktop:bg-hero">
      <Section.Container>
        <header className="min-h-[700px] grid-cols-12 items-center gap-4 pt-12 desktop:grid desktop:h-[65vh]">
          <div className="col-span-5">
            ...
            <p className="mt-8 space-x-2">
              <a
                href="https://calendly.com/benjamin-boileux"
          ...
          <img
            ...
            alt=""
            className="col-span-7 hidden self-end desktop:block"
          />
        </header>
      </Section.Container>
    </div>
