...
meta:
  ...
  - name: og:title
    content: En 2023, comment reprendre le contrôle de vos dépenses de logiciels SaaS ?
  - name: og:type
    content: article
  - name: og:image
    content: https://images.unsplash.com/photo-1579621970795-87facc2f976d&w=800
  - name: og:description
    content:
      'Avec le contexte économique actuel, l’optimisation des coûts est devenue une priorité pour
      chaque entreprise en 2023. Un centre de coût important à analyser en priorité est l’abonnement
      ...
      étapes afin de mieux contrôler la gestion de ces dépenses.'
  - name: og:url
    content: https://www.ocobo.co/media/2
title: En 2023, comment reprendre le contrôle de vos dépenses de logiciels SaaS ?
author: Aude Cadiot
read: 4 min
