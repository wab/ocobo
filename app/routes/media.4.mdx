...
meta:
  ...
  - name: og:title
    content: Les grands principes d’un plan de compensation réussi
  - name: og:type
    content: article
  - name: og:image
    content: https://images.unsplash.com/photo-1601067179601-37820bd0339a?&w=800&h=600&fit=crop
  - name: og:description
    content:
      Ces dernières années, plusieurs facteurs ont amené la rémunération variable des équipes
      commerciales à être pensée et conçue de manière plus scientifique par les équipes Ops. Cet
      ...
      et contrôlables pour l’organisation.
  - name: og:url
    content: https://www.ocobo.co/media/4
read: 6 min
