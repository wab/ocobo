...
meta:
  ...
  - name: description
    content:
      ...
      choisir et de s’assurer qu’il répondra le mieux au besoin de votre business. Nous vous
      proposons trois étapes clés pour vous accompagner dans cette démarche.
  - name: og:title
    content: Les 3 étapes pour choisir un nouvel outil
  - name: og:type
    content: article
  - name: og:image
    content: https://images.unsplash.com/photo-1569803903286-eb86d49af323?&w=800&h=600&fit=crop
  - name: og:description
    content:
      Face à un éco-système d’outils de plus en plus vaste, il est difficile de savoir quel outil
      choisir et de s’assurer qu’il répondra le mieux au besoin de votre business. Nous vous
      proposons trois étapes clés pour vous accompagner dans cette démarche.
  - name: og:url
    content: https://www.ocobo.co/media/5
read: 6 min
