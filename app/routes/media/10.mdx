...
meta:
  ...
  coverImage: https://images.unsplash.com/photo-1493612276216-ee3925520721?ixlib=rb-4.0.3&q=85&fm=jpg&cs=srgb&w=1200&h=800&fit=crop
  ...
  author: Aude Cadiot
  date: 2023-09-12
  og:title: L’agence de conseil en Revenue Operations, un vrai "Business Partner" externalisé
  og:type: article
  og:image: https://images.unsplash.com/photo-1493612276216-ee3925520721?ixlib=rb-4.0.3&q=85&fm=jpg&&cs=srgb&w=1200&h=800&fit=crop
  og:description: Avec cet article, nous vous expliquons concrètement le fonctionnement et l’organisation d’une agence de conseil experte en Business Operations et comment, chez Ocobo, nous accompagnons nos clients au quotidien.
  og:url: https://ocobo.co/media/10
read: 4 min
tags: stratégie, organisation, déploiement
status: published
---
...
Comme expliqué dans nos [précédents articles](https://www.ocobo.co/media/1), les Business Operations (ou leurs spécialisations Revenue Operations, ou Sales Operations) recouvrent un ensemble de métiers qui permettent aux organisations de structurer et d’optimiser leurs fonctions en charge de générer du chiffre d’affaires.

🎯 Le but : **connecter** le marketing, la vente, le service client et la finance afin de se mettre au **service de la croissance**, de générer des ventes **prédictibles** et de viser l’**excellence opérationnelle**.
...
La **première phase d’une mission** avec Ocobo est toujours initiée, gérée, et suivie par un de nos **directeurs Business Ops** afin d’apporter une **expertise forte sur le métier** et permettre de réaliser en fonction de la taille de la mission :
