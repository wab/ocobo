---
meta:
  title: Les différents rôles en Revenue Operations | 1. Le Business Ops Manager
  coverImage: https://images.unsplash.com/photo-1543269865-cbf427effbad?&w=1200
  ...
  date: 2023-02-20
  og:title: Les différents rôles en Revenue Operations | 1. Le Business Ops Manager
  og:type: article
  og:image: https://images.unsplash.com/photo-1543269865-cbf427effbad?&w=800
  og:description: Sales Ops Manager, Revenue Ops Manager, Business Ops Manager, Growth Hacker, Sales Enablement, Performance Manager… on voit émerger depuis quelques années de nouveaux intitulés de poste qui restent difficiles à appréhender même quand on gravite dans le milieu. Cette série d’articles a été pensée pour vous aider à y voir plus clair et mieux comprendre leurs rôles et missions. Aujourd’hui, on vous explique le rôle du Business Ops Manager.
  og:url: https://ocobo.co/media/3
read: 4 min
tags: organisation
status: published
---
...
- Documenter au maximum les process dans le _knowledge management center_ pour s’assurer que les ressources sont accessibles, à jour et actionnables par les managers.
...
- Le Business Ops Manager est en fait notre Product Manager interne, à savoir un _problem solver_, qui a à sa disposition tout un panel d’outils au sens large (process métiers, CRM, outil de facturation, dashboards, etc.) sur lesquels il va pouvoir s’appuyer et qu’il pourra faire évoluer pour répondre à des besoins utilisateurs ;
