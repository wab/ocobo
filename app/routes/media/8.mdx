...
meta:
  ...
  description:
    ...
    détail ces étapes. Dans ce second article, on aborde le sujet du contenu du plan de compensation
    ; les indicateurs, les méthodes de rétribution, les mécanismes de courbes, et bien d’autres
    sujets.
